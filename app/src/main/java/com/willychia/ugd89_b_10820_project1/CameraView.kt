package com.willychia.ugd89_b_10820_project1
...
class CameraView (Context: Context?, private val mCamera: Camera) : SurfaceView(Context), SurfaceHolder.Callback{
    ...
    override fun surfaceChanged(p0: SurfaceHolder, p1: Int, p2: Int, p3: Int) {
        if(mHolder.surface == null) return
        try{
            mCamera.setPreviewDisplay(mHolder)//fungsi ini membuat kamera hanya bisa melakukan preview dan tidak bisa memotret
            mCamera.startPreview()
        }catch (e : IOException){
